...
import com.test.example.repository.TODORepository;
...
public class TODOResourceIT {
    ...
    public void createTODO() throws Exception {
        ...
        // Create the TODO
        restTODOMockMvc.perform(post("/api/todos").with(csrf())
        ...
        assertThat(testTODO.getNumber()).isEqualTo(DEFAULT_NUMBER);
    ...
    public void updateTODO() throws Exception {
        ...
        restTODOMockMvc.perform(put("/api/todos").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThat(testTODO.getNumber()).isEqualTo(UPDATED_NUMBER);
    ...
    public void deleteTODO() throws Exception {
        ...
        // Delete the tODO
        restTODOMockMvc.perform(delete("/api/todos/{id}", tODO.getId()).with(csrf())
