package com.test.example.web.rest;

import com.test.example.ExampleApp;
import com.test.example.config.Constants;
import com.test.example.domain.PersistentToken;
import com.test.example.domain.User;
import com.test.example.repository.AuthorityRepository;
import com.test.example.repository.PersistentTokenRepository;
import com.test.example.repository.UserRepository;
import com.test.example.security.AuthoritiesConstants;
import com.test.example.service.UserService;
import com.test.example.service.dto.PasswordChangeDTO;
import com.test.example.service.dto.UserDTO;
import com.test.example.web.rest.vm.KeyAndPasswordVM;
import com.test.example.web.rest.vm.ManagedUserVM;
...
import static com.test.example.web.rest.AccountResourceIT.TEST_USER_LOGIN;
